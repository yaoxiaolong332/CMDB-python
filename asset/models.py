...
class Asset(models.Model):
    ...
    business_unit=models.ForeignKey('BusinessUnit',verbose_name=u'所属业务线')
    tags=models.ManyToManyField('Tag',blank=True)

    admin=models.ForeignKey('UserProfile',verbose_name=u'资产管理员',null=True)
...
class NetworkDevice(models.Model):
    ...
    device_detail=models.TextField(u'设置详细个数',blank=True,null=True)
...
class Software(models.Model):
    ...
    type=models.CharField(u'系统类型',choices=os_type_choice,max_length=64)
    distribution=models.CharField(u'发型版本',choices=os_distribution_choices,max_length=64)
    version=models.CharField(u'软件/系统版本',max_length=64)
    language_choice=(('ch',u'中文'),('en',u'英文'))
    language=models.CharField(u'系统语言',choices=language_choice,default="ch",max_length=128)
    def __unicode__(self):
        return self.version
    class Meta:
...
class Disk(models.Model):
    ...
    capacity=models.CharField(u'磁盘容量GB',max_length=128)
    disk_iface_choice=(
        ('SATA','SATA'),
        ('SAS','SAS'),
        ('SCSI','SCSI'),
...
class Manufactory(models.Model):
    manufactory=models.CharField(u'厂商名称',max_length=64,unique=True,default='惠普')
    support_num=models.CharField(u'支持电话',max_length=64,blank=True)
    memo=models.TextField(u'备注',blank=True,null=True)
    create_date=models.DateTimeField(auto_now_add=True)
    update_date=models.DateTimeField(blank=True,null=True)
    def __unicode__(self):
...
class NewAssetApprovalZone(models.Model):
    ...
    approved_by=models.ForeignKey('UserProfile',verbose_name=u'批准入',blank=True)
