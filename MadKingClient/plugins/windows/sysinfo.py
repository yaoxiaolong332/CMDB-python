...
class Win32Info(object):
    def __init__(self):
        ...
        self.wmi_service_connector=self.wmi_server_obj.ConnectServer('.','root\cimv2')
        ...
        for nic in self.wmi_obj.Win32_NetworkAdapterConfiguration():
            if nic.MACAddress is not None:
                ...
                if nic.IPAddress is not None:
                    item_data['ipaddress']=nic.IPAddress
...
def collect():
    data={
        ...
        'os_release':"%s %s" %(platform.release(),platform.architecture()),
